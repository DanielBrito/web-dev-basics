...
function main() {
  var _iterator = _createForOfIteratorHelper(_invoices["default"]),
      _step;

  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var invoice = _step.value;
      console.log((0, _statement.statement)(invoice, _plays["default"]));
    }
  } catch (err) {
    _iterator.e(err);
  } finally {
  ...
  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
      var _invoice = _step2.value;
      console.log((0, _statement.htmlStatement)(_invoice, _plays["default"]));
    }
  } catch (err) {
    _iterator2.e(err);
  } finally {
